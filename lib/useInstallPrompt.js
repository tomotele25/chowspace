...
export function useInstallPrompt() {
  ...
  // Platform is knowable synchronously — just the UA string, no async browser
  // event to wait on — so it's set from a layout effect. That commits before
  // the browser paints the first frame; a normal effect runs after paint and
  // would visibly insert content a frame late, which reads as layout shift.
  useLayoutEffect(() => {
