...
//   /* ── Delivery zone: "local" = within vendor city, "outside" = elsewhere ── */
...
//         // ── If vendor is not in Abeokuta, redirect to chat ──
...
//   /* ── Zone change: reset location-dependent state ── */
//   const handleZoneChange = (zone) => {
//     setDeliveryZone(zone);
//     setDeliveryDetails((p) => ({ ...p, location: "" }));
//     setDeliveryFee(0);
//   };
...
//   /* ── Route outside-city customers to chat.js ── */
//   const handleOutsideOrder = () => {
...
//   const vendorCity = vendor.location || "your city";
//   const isOutside = deliveryZone === "outside";
...
//             Order from{" "}
//             <span className="text-[#AE2108]">{vendor.businessName}</span>
//             <Link href="/chat" vendorId={vendor._id}>
//               click here
//             </Link>
//           </h1>
//           <p className="text-gray-500">
...
//                 <Navigation size={18} className="text-[#AE2108]" />
...
//                 <button
//                   type="button"
//                   onClick={() => handleZoneChange("local")}
//                   className={`py-4 px-4 rounded-xl text-sm font-semibold border-2 transition text-left ${
//                     deliveryZone === "local"
//                       ? "border-[#AE2108] bg-[#AE2108]/5 text-[#AE2108]"
//                       : "border-gray-200 text-gray-500 hover:border-gray-300"
//                   }`}
//                 >
//                   <p className="font-bold">Within {vendorCity}</p>
//                   <p
...
//                   }`}
//                 >
//                   <p className="font-bold">Outside {vendorCity}</p>
//                   <p
//                     className={`text-xs mt-0.5 font-normal ${
//                       deliveryZone === "outside"
//                         ? "text-orange-500"
...
//                     }`}
//                   >
//                     Chat to arrange delivery
//                   </p>
//                 </button>
//               </div>

//               {/* Outside city info banner */}
//               {isOutside && (
...
//                       Outside delivery requires a chat
//                     </p>
//                     <p className="text-xs text-orange-600 mt-0.5 leading-relaxed">
//                       Since you&apos;re ordering from outside {vendorCity}, fill
//                       in your details below and we&apos;ll connect you with the
//                       vendor to sort out delivery cost and logistics.
//                     </p>
//                   </div>
//                 </div>
//               )}
...
//                 onSubmit={(e) => {
//                   e.preventDefault();
//                   isOutside ? handleOutsideOrder() : handlePay();
//                 }}
//                 className="space-y-4"
//               >
//                 {[
...
//                 {/* Location dropdown — local orders only */}
//                 {!isOutside && (
//                   <div className="relative">
//                     <MapPin
//                       size={16}
...
//                 {/* CTA button — changes based on zone */}
//                 <button
//                   type="submit"
//                   disabled={loading}
//                   className={`w-full mt-4 py-4 rounded-xl font-bold text-white text-base transition flex items-center justify-center gap-2 ${
...
//                 <p className="text-center text-xs text-gray-400 pt-1">
//                   {isOutside
//                     ? "You'll be taken to a chat to arrange outside delivery"
//                     : "You'll be redirected to WhatsApp to confirm your order"}
//                 </p>
//               </form>
//             </div>
