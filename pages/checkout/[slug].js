...
// /* ─── Birthday Nudge Card ─────────────────────────────────── */
// function BirthdayNudge({ vendorId }) {
...
//         </div>
//         <p className="font-bold text-gray-900 text-sm mb-1">Birthday saved!</p>
//         <p className="text-xs text-gray-500">
//           We&apos;ll send you a treat when your special day comes around.
//         </p>
//       </div>
//     );
//   }
...
//   return (
//     <div className="bg-white rounded-2xl border border-amber-200 p-6 relative">
//       {/* Dismiss button */}
//       <button
//         type="button"
...
//       {/* Badge */}
//       <span className="inline-flex items-center gap-1.5 text-xs font-semibold bg-amber-100 text-amber-800 rounded-full px-3 py-1 mb-4">
//         <Gift size={12} />
//         Members-only perk
//       </span>

//       <h2 className="text-base font-bold text-gray-900 mb-1 flex items-center gap-2">
//         Get a free birthday treat
//       </h2>
//       <p className="text-xs text-gray-500 mb-5 leading-relaxed">
//         Add your birthday and we&apos;ll surprise you with a discount on your
//         special day. Totally optional — no spam, promise.
//       </p>
...
//           className="flex-1 px-3 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:ring-2 focus:ring-[#AE2108]/20 focus:border-[#AE2108] outline-none transition"
//         >
...
//           className="w-24 px-3 py-2.5 rounded-xl border border-gray-200 bg-gray-50 text-sm focus:ring-2 focus:ring-[#AE2108]/20 focus:border-[#AE2108] outline-none transition"
//         />
...
//           onClick={handleSave}
//           disabled={saving}
//           className="px-4 py-2.5 bg-[#AE2108] text-white rounded-xl text-sm font-bold hover:bg-[#941B06] transition disabled:opacity-50 disabled:cursor-not-allowed whitespace-nowrap"
//         >
//           {saving ? (
//             <div className="w-4 h-4 border-2 border-white border-t-transparent rounded-full animate-spin" />
//           ) : (
...
//           Sign in to track your orders, save your address and earn rewards.
//         </p>
//         <Link
//           href="/auth/signin"
//           className="inline-flex items-center gap-1.5 text-xs font-semibold border border-[#AE2108] text-[#AE2108] rounded-xl px-3 py-2 hover:bg-[#AE2108]/5 transition whitespace-nowrap flex-shrink-0"
//         >
//           <LogIn size={12} />
//           Sign in
//         </Link>
...
//         type="button"
//         onClick={() => setDismissed(true)}
//         className="block text-xs text-gray-400 underline underline-offset-2 mt-4 mx-auto hover:text-gray-500 transition"
//       >
//         No thanks, skip this
//       </button>
//     </div>
...
//             {/* ── Birthday / Sign-in Nudge (guests only) ── */}
//             {!session?.user && <BirthdayNudge vendorId={vendor?._id} />}
...
//               {/* Sign-in hint in sidebar for logged-out users */}
//               {!session?.user && (
...
//                     Sign in to save your details and earn birthday rewards on
//                     future orders.
//                   </p>
//                 </div>
//               )}
